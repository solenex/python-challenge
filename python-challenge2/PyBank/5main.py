...
print(csv_list[7]['Profit/Losses'])

net_change_sum = 0
net_change_count = 0
for index in range(2, 86):
    net_change = int(csv_list[index]["Profit/Losses"]) - int (csv_list[index - 1]["Profit/Losses"])
    net_change_sum += net_change
    net_change_count = net_change_count + 1

revenue_avg = net_change_sum / net_change_count
print(revenue_avg)
